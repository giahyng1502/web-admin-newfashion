                                    ...
                                    <PrivateRoute>
                                        ...
                                        <main className="content">
                                            ...
                                            <Routes>
                                                ...
                                                <Route path="/statistics/order" element={<StatisticsOrder />} />
                                                <Route path="/statistics/product" element={<StatisticsTopProduct />} />
                                                <Route path="/statistics/user" element={<StatisticsUser />} />
                                                <Route path="/statistics/low-product" element={<StatisticsLowProduct />} />
